...
class TestDataIntegrity:
    ...
    def test_researcher_data_consistency(self, database_url):
        """Test that researcher data is consistent"""
        try:
    ...
    @pytest.mark.database
    def test_works_data_consistency(self, database_url):
        """Test that works data is consistent"""
        try:
            conn = psycopg2.connect(database_url)
    ...
    @pytest.mark.database
    def test_embedding_data_integrity(self, database_url):
        """Test that embedding data is properly formatted"""
        try:
            conn = psycopg2.connect(database_url)
    ...
    @pytest.mark.database
    def test_referential_integrity(self, database_url):
...
class TestQueryPerformance:
    ...
    @pytest.mark.database
    @pytest.mark.slow
    def test_basic_query_performance(self, database_url):
    ...
    @pytest.mark.database
    @pytest.mark.slow
    def test_join_query_performance(self, database_url):
        """Test that join queries execute within reasonable time"""
        import time
...
class TestDataValidation:
    ...
    @pytest.mark.database
    def test_researcher_name_format(self, database_url):
        """Test that researcher names follow expected format"""
        try:
            conn = psycopg2.connect(database_url)
    ...
    @pytest.mark.database
    def test_publication_year_range(self, database_url):
        """Test that publication years are within reasonable range"""
        try:
            conn = psycopg2.connect(database_url)
